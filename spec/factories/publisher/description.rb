FactoryGirl.define do
  factory :st_publisher_description do
    # influencers_size              { Faker::Number.number(3) }

    factory :st_publisher_business_description, class: OpenStruct do
    ...
    factory :st_publisher_pr_agency_description, class: OpenStruct do
    end
  end
end
